...
<div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Slider Yönetimi</strong>
                            </div>
                              </div>
            </div>
          </div>
  ...
  <?php }?>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                          <div><br>
                                            ...
                                            <form method="post"  enctype="multipart/form-data" autocomplete="off" action="<?=base_url()?>admin/slider/guncelle/<?=$resim[0]->id?>" role="form">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="file" name="resim_adi" value="<?=$resim[0]->resim_adi?>" class="form-control" id="email1" placeholder="Yükleme için gözat"><?=$resim[0]->resim_adi?>
